...
from gatetool import checker_stripe 
token = "8520709238:AAHugv9AsIxz2ZFG7pd-ZgtqPPuKR_b84bU" # داخل الاشارات توكن بوتك
...
𝒃𝒚 ➜ @Lx0b2 ''', reply_markup=mes)
				
				try:
					last = str(checker_stripe(cc))
...
◆𝑷𝑹𝑶𝑿𝒀𝑺: 𝑷𝑹𝑶𝑿𝒀 𝑳𝑰𝑽𝑬 ✅ '''
				...
				if "result': True" in last:
					...
					live += 1
					bot.reply_to(message, msg)
				elif "requires_payment_method" in last:
					ch += 1
					msg1 = f'''◆ 𝑪𝑨𝑹𝑫  ➜ {cc}
◆ 𝑺𝑻𝑨𝑻𝑼𝑺 ➜ 𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱  ✅ 
◆ 𝑹𝑬𝑺𝑼𝑳𝑻 ➜ #Approved
